...
class CacheClient:
    ...
    def simulate_searches(self, n_searches=100):
        ...
        count = 0
        total_time = 0  # Agregar una variable para rastrear el tiempo total de simulación
        ...
        for key in keys_to_search:
            ...
            find_car_by_id(int(key))# Simula la búsqueda directamente en el JSON
            ...
            total_time += elapsed_time  # Agregar el tiempo de esta búsqueda al tiempo total
